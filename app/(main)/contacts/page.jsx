...
import { useGetContactedEntitiesQuery } from "@/redux/services";
...
export default function ContactsPage() {
  ...
  if (isLoading || !userContactedWith.data) {
    return (
  ...
  const  { users , groups} = userContactedWith?.data || {users:[],groups:[]};

  // console.log(" now expense with userd",users)
  // console.log(" now expense with groups",groups)
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="">
          ...
          {users && users.length === 0 ? (
            ...
            <div className="flex flex-col gap-4 md:max-h-[70vh] md:overflow-auto">
