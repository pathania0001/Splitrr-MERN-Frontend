...
import { useLazyGetAllUsersQuery } from "@/redux/services";
...
const [getUsers, { data: searchResults,isSuccess, isLoading }] = useLazyGetAllUsersQuery();
...
const addParticipant = (user) => {
    ...
    const newUser = {id:_id , name,email,imageUrl};

    onParticipantsChange([...participants, newUser]);
    setOpen(false);
    setSearchQuery("");
};
              ...
              <Command>
                ...
                <CommandList>
                  ...
                  <CommandGroup heading="Users">
                    {isSuccess && searchResults?.data?.map((user) => (
                      <CommandItem
                        key={user._id}
