...
import { useGetExpenseWithUserQuery } from "@/redux/services";
...
export default function PersonExpensesPage() {
  ...
  //   { userId: params.id }
  // );
   const {data,isLoading} = useGetExpenseWithUserQuery(params.id,{ refetchOnMountOrArgChange: true,})
  //  console.log("data expenses with user",data);
  if (isLoading) {
    return (
  ...
  const balance = data?.data?.netBalanceOfUser || 0;
