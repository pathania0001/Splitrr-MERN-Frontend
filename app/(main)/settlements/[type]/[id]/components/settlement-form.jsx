...
import { useCreateSettlementMutation } from "@/redux/services";
...
export default function SettlementForm({ entityType, entityData, onSuccess }) {
    ...
    try {
      ...
      const paidByUserId =
        data.paymentType === "youPaid"
          ? currentUser.id
          : entityData.counterpart._id;

      const receivedByUserId =
        data.paymentType === "youPaid"
          ? entityData.counterpart._id
          : currentUser.id;
    //  console.log("Amount enter :",amount)
    //  console.log("paidBy userenter :",paidByUserId)
    //  console.log("recieved BY iser:",receivedByUserId)
     ...
     //console.log("result on submitting the settlement :",result)
  ...
  if (entityType === "user") {
    ...
    //  console.log(" other User :",otherUser,currentUser)
    //  console.log(" other netBAlance :",netBalance)
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <span className="absolute left-3 top-2.5">̥₹</span>
            <Input
              id="amount"
              placeholder="0.00"
              type="number"
