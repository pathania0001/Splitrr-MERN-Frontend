...
import { useDeleteExpenseMutation } from "@/redux/services";
...
export function ExpenseList({
  ...
  const canDeleteExpense = (expense) => {
    ...
    return (
      expense.createdBy_id === currentUser.id ||
      expense.paidByUserId._id === currentUser.id
    );
  };
 ...
 //console.log("look up",userLookupMap)
  return (
    <div className="flex flex-col gap-4">
      {expenses.map((expense) => {
        const payer = expense.paidByUserId;
        const isCurrentUserPayer = expense.paidByUserId._id === currentUser?.id;
              ...
              <div className="mt-3 text-sm">
                <div className="flex gap-2 flex-wrap">
                  {expense.splits.map((split, idx) => {
                    ...
                    const isCurrentUser = split.userId._id === currentUser?.id;
                     

                    const shouldShow =
                      showOtherPerson ||
                      (!showOtherPerson &&
                        (split.userId._id === currentUser?.id ||
                          split.userId._id === otherPersonId));
